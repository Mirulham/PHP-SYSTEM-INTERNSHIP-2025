...
if (!empty($_POST))
{
    ...
    $user_pass = hash_hmac("sha512", $_POST['reg_user_pass'], "majlisperbandaransungaipetani");
    
	#pengesahan data
	if (empty ($user_name) || empty ($user_ic) || empty ($user_email) || empty ($user_pass)) {
	...
	if (mysqli_num_rows($check_result) > 0) {
		...
		$arahan_sql_simpan = "INSERT INTO tb_users(user_name,user_ic,user_email,user_pass,user_level)VALUES('$user_name','$user_ic','$user_email','$user_pass','2')";
