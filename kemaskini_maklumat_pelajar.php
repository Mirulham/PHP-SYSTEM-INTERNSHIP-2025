                ...
                <form class="needs-validation" novalidate action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" enctype="multipart/form-data" method="POST" onSubmit="return capture();">
                        ...
                        <div class="form-group row mb-3">
                            <div class="form-group col-md-12">
                                ...
                                <input type="hidden" class="form-control" placeholder="Sila Masukkan Nama Pelajar" name="id_users" value="<?php echo $data_id_users; ?>">
                        ...
                        <div class="form-group row mb-3">
                            <div class="form-group col-md-12">
                                <label for="inputEmail4">Alamat Surat Menyurat</label>
                                <textarea type="text" class="form-control" name="alamat" id="" placeholder="Sila Masukkan Alamat Surat Menyurat"><?PHP echo $data_alamat; ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-3">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control datepicker" placeholder="Sila Masukkan Tarikh Lahir" name="tarikh_lahir" value="<?php echo $data_tarikh_lahir; ?>" autocomplete="off" required>
                            </div>
                                ...
                                <select class="form-control select2" name="id_gender" required autofocus>
                                    ...
                                    <?php
                                        ...
                                        while($data=dbarray($rs)){
                                            ...
                                            // echo "<option value='".$id_gender."'>".$gender_name."</option>";
                                            echo "<option value='".$id_gender."' ".($id_gender==$data_id_gender?"selected='selected'" :"").">".$gender_name."</option>";
                                        }
                                    ?>
                                </select>
                            </div>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" placeholder="Sila Masukkan No Telefon" value="<?php echo $data_no_telefon; ?>" name="no_tel" required>
                            </div>                                
                        </div>
                                ...
                                <select class="form-control select2" name="id_ipta" required autofocus>
                                    ...
                                    <?php
                                        ...
                                        while($data=dbarray($rs)){
                                            ...
                                            $ipta_name = $data['ipta_name'];
                                        
                                            // echo "<option value='".$id_ipta."'>".$ipta_name."</option>";
                                            echo "<option value='".$id_ipta."' ".($id_ipta==$data_id_ipta?"selected='selected'" :"").">".$ipta_name."</option>";
                                        }
                                    ?>
                                </select>                                          
                            </div>
                                ...
                                <select class="form-control select2" name="id_course" required autofocus>
                                    ...
                                    <?php
                                        ...
                                        while($data=dbarray($rs)){
                                            ...
                                            echo "<option value='".$id_course."' ".($id_course==$data_id_course?"selected='selected'" :"").">".$course_name."</option>";
                                        }
                                    ?>
                                </select>
                            </div>
                        ...
                        <div class="form-group row mb-3">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control datepicker" placeholder="Sila Masukkan Tarikh Mula" autocomplete="off" value="<?php echo $data_tarikh_mula; ?>" name="tarikh_mula" required>
                            </div>
                        ...
                        <div class="form-group row mb-3">
                            <div class="col-md-12 mt-3" style="text-align: center;">
                                <button type="submit" name="Submit" value="Submit" class="btn btn-primary btn-block">
                                    <i class="fa-duotone fa-regular fa-up"></i> KemasKini Maklumat
                                </button>
                            </div>
                        </div>
                        </form>
