...
if (isset($_GET['success']) && $_GET['success'] == "4") {
    echo "<script>
            setTimeout(function() {
                Swal.fire({
                    position: 'top-end', showConfirmButton: false, titleText: 'Selamat Kembali!', text: 'Anda Telah Berjaya Log Masuk!', icon: 'success', timerProgressBar: true, timer: 3000
                });
            }, 600);
        </script>";
}
...
if (isset($_GET['success']) && $_GET['success'] == "5") {
    echo "<script>
            setTimeout(function() {
                Swal.fire({
                    position: 'top-end',showConfirmButton: false, titleText: 'Berjaya!', text: 'Anda Telah Berjaya Log Keluar!',
                    icon: 'success', timerProgressBar: true, timer: 3000
                });
            }, 600);
        </script>";
}
...
if(isset($_GET['error']) && $_GET['error'] == "3") {
    echo "<script>
            setTimeout(function() {
                Swal.fire({
                    position: 'top-end', showConfirmButton: false, titleText: 'Akses Ditolak!', text: 'Anda tiada akses untuk tindakan ini.', icon: 'warning', timerProgressBar: true, timer: 3000
                })
            }, 600);
        </script>";
}
