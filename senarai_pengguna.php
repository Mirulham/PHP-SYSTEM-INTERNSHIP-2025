                                        ...
                                        <?php
                                            ...
                                            if(dbrows($result)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p>".getDataFromTable('level_name',$data['user_level'],'id_level','lt_level')."</p>
                                                    </td>";
                                                    ?>
                                                    <?php 
                                                        if ($user_level == 1) {
                                                            ...
                                                            echo "
                                                            <td align='center' width='1%'>
                                                                <a href='".htmlspecialchars($_SERVER['PHP_SELF'])."?error=3'><i class='fas fa-edit fa-2x'></i></a>&nbsp;&nbsp;
                                                                <a href='".htmlspecialchars($_SERVER['PHP_SELF'])."?error=3' onClick=\"return deletebuttonask()\"><i class='fas fa-trash fa-2x'></i></a>
                                                            </td>";
                                                        }
                                                   echo"
                                                </tr>";
