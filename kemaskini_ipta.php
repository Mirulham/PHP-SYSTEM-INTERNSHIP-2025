...
if ($id_ipta != "") {
	...
	$data_ipta_name = $rekod['ipta_name'];
                                ...
                                <form class="needs-validation" novalidate action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" enctype="multipart/form-data" method="POST" onSubmit="return capture();">
                                    ...
                                    <div class="form-group row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control" placeholder="Sila Masukkan Nama IPTA" name="ipta_name" value="<?php echo $data_ipta_name; ?>" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
