...
<html lang="en">
		...
		<title>
			<?php 
				if ($user_level == 1) {
					...
					echo "Dashboard - Student Internship";
				}
			?>
		</title>
	...
	<body class="sb-nav-fixed">
		<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
			<!-- Navbar Brand-->
			<a class="navbar-brand ps-3" href="index.php">My Practical System</a>
			<!-- Sidebar Toggle-->
			...
			<ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
				<li class="nav-item dropdown">
					...
					<ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
						...
						<li>
							<a class="dropdown-item" href="logout.php?logout=yes" onClick="return logoutask();">Logout</a>
						</li>
					</ul>
				</li>
			</ul>
			...
			<div id="layoutSidenav_nav">
				<nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
					...
					<div class="sb-sidenav-footer">
						<div class="small">Logged in as:</div> <?php echo $user_email; ?>
					</div>
				</nav>
			</div>
